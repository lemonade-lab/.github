...
- [lvyjs](https://lvyjs.dev)：开发环境与打包工具
- `jsxp`：截图工具
- `alemondesk`：桌面端版本
- `alemongo`：服务端版本
...
- [官网首页](https://alemonjs.com/)
- [快速开始文档](https://alemonjs.com/docs/start/)
- [GitHub 仓库](https://github.com/lemonade-lab/alemonjs)
- 在线测试环境：可在官网入口中直接体验
- Web 面板 / 桌面启动：适合快速验证与调试
...
- **官网文档**：[alemonjs.com](https://alemonjs.com/)
- **项目仓库**：[lemonade-lab/alemonjs](https://github.com/lemonade-lab/alemonjs)
- **问题反馈**：[GitHub Issues](https://github.com/lemonade-lab/alemonjs/issues)
- **社区交流**：官网提供 QQ 群入口，可用于日常交流与反馈
- **组织成员**：[GitHub People](https://github.com/orgs/lemonade-lab/people)

---

## 鸣谢

- **创始人**：感谢 [柠檬冲水（ningmengchongshui）](https://github.com/ningmengchongshui)

- **开发者**：[特别感谢所有项目组的贡献 ❤️（点击下图前往组织 People 页面）](https://github.com/orgs/lemonade-lab/people)
